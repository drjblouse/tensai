...
class TestTypes(TestCase):
    ...
    def test_logger(self):
        ...
        self.assertTrue(exc_obj == FACT1_NAME and filename == FACT1_NAME)

    def test_rule(self):
        mock = MagicMock()
        knowledge = Knowledge(mock)
        knowledge.add_rule(Rule(TEST_RULE, mock))
        self.assertTrue(knowledge.rule_exists(Rule(TEST_RULE, mock)))
    ...
    def test_fact(self):
        ...
        self.assertTrue(knowledge.fact_exists(Fact(TEST_FACT1, mock)))
        knowledge.retract_fact(Fact(TEST_FACT1, mock))
        mock.delete.assert_called_once()
        mock.get.return_value = None
        self.assertFalse(knowledge.fact_exists(Fact(TEST_FACT1, mock)))
